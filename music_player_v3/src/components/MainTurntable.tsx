  ...
  return (
    <div className="relative flex flex-col items-center justify-center mb-8">
      <div className="relative flex items-center justify-center mb-16">
        ...
        {/* Brazo del tocadiscos FIJO (fuera del disco giratorio) */}
        <div className={`absolute top-8 right-8 w-1 h-32 bg-gradient-to-b from-cyan-400 to-fuchsia-400 rounded-full shadow-[0_0_15px_#00ffff] transition-transform duration-1000 ${isPlaying ? 'rotate-12' : 'rotate-0'}`} style={{transformOrigin: 'top center'}}></div>
      </div>
      
      {currentSong && (
        <div className="text-center max-w-md px-4">
          <div 
            className="text-cyan-400 font-bold text-2xl drop-shadow-[0_0_15px_#00ffff] animate-pulse mb-2 truncate" 
